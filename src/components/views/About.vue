<template>
  <div id="about" class="about">
    ...
    <div id="main-icons" class="container-fluid">
      <h3 class="h2" data-aos="fade-bottom">
        My 4 top priorities:
      </h3>
      <div class="row">
        <div class="col-md-6">
          <div class="col-md-9 offset-md-2 card my-5 justify-content-center" data-aos="fade-right">
...
<g>
	<g>
		<circle class="fade" style="fill:rgb(238,196,92)" cx="256.003" cy="342.305" r="12.738"/>
	</g>
</g>
<g>
	<g>
		<path class="fade" style="fill:rgb(238,196,92)" d="M276.238,109.254c-4.61-4.609-12.081-4.609-16.693,0l-83.414,83.414c-4.609,4.609-4.609,12.083,0,16.693
...
<g>
	<g>
		<path class="fade" style="fill:rgb(238,196,92)" d="M325.678,157.593c-4.608-4.609-12.079-4.609-16.692-0.001l-33.23,33.228c-4.609,4.61-4.609,12.084,0,16.693
          ...
          <div
                  id="responsive"
            class=" bigImage d-none d-md-block my-5"
            data-aos="fade-right"
                  data-aos-delay="750"
          >
          </div>
...
<g>
	<g style="transform-origin: 33% 67%" class="spin">
...
<g>
	<g>
		<path style="fill:rgb(238,196,92)" d="M241.762,312.511c0,0,0,0-0.001-0.001c-16.48-39.789-62.256-58.752-102.051-42.271
...
<g>
	<g>
		<path style="fill:rgb(238,196,92); transform-origin: 74% 25%" class="spinBack" d="M496.553,100.936c-3.956-0.592-8.019-1.167-12.111-1.713c-2.062-6.857-4.816-13.505-8.214-19.819
...
<g>
	<g>
        ...
        <div class="col-md-6">
          ...
          <div class="col-md-9 offset-md-1  card my-5 justify-content-center" data-aos="fade-left">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
<g>
	<g>
...
<g>
	<g>
		<path class="fade" style="fill:rgb(238,196,92)" d="M466.29,174.403c-1.445-23.38-11.35-45.366-27.891-61.909c-11.712-11.712-26.245-20.222-42.026-24.615
          ...
          <div
                  id="dynamic"
            class="d-none d-md-block my-5 content-center"
            data-aos="fade-left"
                  data-aos-delay="750"
          >
          </div>
...
<g>
	<g>
		<path style="fill:rgb(238,196,92)" d="M256,202.804c-29.332,0-53.195,23.863-53.195,53.195s23.863,53.195,53.195,53.195s53.195-23.863,53.195-53.195
...
<style scoped>
  ...
  #dynamic{
    background-image: url("../../assets/dynamic.jpg");
  }
  #seo{
...
.spin{
  animation: spin ease 15s infinite;
}
.spinBack{
