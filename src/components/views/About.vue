  ...
  <div id="about" class="about">
    ...
    <div id="main-icons" class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-6">
          <div
            class="col-md-9 offset-md-2 card my-5 justify-content-center"
            data-aos="fade-right"
          >
            <svg
              version="1.1"
          ...
          >
            ...
            >
              <g>
                <g style="transform-origin: 33% 67%" class="spin">
                  <path
                    d="M328.844,368.733c-5.383-3.235-10.908-6.487-16.433-9.675c1.299-11.07,1.302-22.268,0.006-33.316
			...
			c5.296,3.049,10.596,6.161,15.772,9.263L305.116,413.834z"
              ...
              <g>
                <g>
                  <path
                    style="fill:rgb(238,196,92)"
                    d="M241.762,312.511c0,0,0,0-0.001-0.001c-16.48-39.789-62.256-58.752-102.051-42.271
			...
			c21.667,0,42.265,12.84,51.06,34.07C232.234,349.395,218.834,381.742,190.72,393.388z"
              ...
              <g>
                <g>
                  <path
                    style="fill:rgb(238,196,92); transform-origin: 74% 25%"
                    class="spinBack"
                    d="M496.553,100.936c-3.956-0.592-8.019-1.167-12.111-1.713c-2.062-6.857-4.816-13.505-8.214-19.819
			...
			c1.939,7.04,7.892,12.201,15.165,13.15c3.677,0.48,7.343,0.985,10.935,1.507V138.142z"
              ...
              <g>
                <g>
                  <path
                    d="M381.924,83.675c-25.585,0-46.401,20.815-46.401,46.401c0,25.587,20.815,46.402,46.401,46.402
        ...
        <div class="col-md-6">
          ...
          <div
            class="col-md-9 offset-md-1  card my-5 justify-content-center"
            data-aos="fade-left"
          >
            <svg
              version="1.1"
            ...
            >
              <g>
                <g>
                  <path
                    d="M472.08,81.12c-26.96-27.572-63.022-42.757-101.546-42.757c-37.93,0-73.593,14.773-100.421,41.602L256.267,93.82
              ...
              <g>
                <g>
                  <path
                    class="fade"
                    style="fill:rgb(238,196,92)"
                    d="M466.29,174.403c-1.445-23.38-11.35-45.366-27.891-61.909c-11.712-11.712-26.245-20.222-42.026-24.615
          ...
          >
            ...
            >
              <g>
                <g>
                  <path
                    d="M503.698,231.895c-28.735-36.843-65.956-67.318-107.637-88.128c-42.548-21.243-88.321-32.265-136.104-32.843
			...
			c38.92,19.432,73.678,47.892,100.517,82.303C492.462,251.355,492.462,260.644,487.275,267.295z"
              ...
              <g>
                <g>
                  <path
                    style="fill:rgb(238,196,92)"
                    d="M256,202.804c-29.332,0-53.195,23.863-53.195,53.195s23.863,53.195,53.195,53.195s53.195-23.863,53.195-53.195
